...
class AiPhotosPage extends StatefulWidget {
  const AiPhotosPage({Key? key, this.name = ""}) : super(key: key);

  final String name;

  @override
  State<AiPhotosPage> createState() => _AiPhotosPageState();
}

class _AiPhotosPageState extends State<AiPhotosPage> {
  ...
  Future<Media> fetchMedia() async {
    final response = await http.get(
        Uri.parse('http://127.0.0.1:5000/get_by_name/' + widget.name),
